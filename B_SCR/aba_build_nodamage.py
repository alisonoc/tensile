...
"""
MODIFIED 10/8/22 TO REMOVE DUCTILE DAMAGE. ONLY INTERESTED IN CHECKING MATERIAL PROPERTIES
ARE CALCULATED IN THE CORRECT WAY.
"""
...
my_material = read_material_properties(properties_file)
########################################################
# START BUILD
########################################################
# SET JOURNAL OPTIONS
